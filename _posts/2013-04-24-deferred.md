...
You can add callbacks to the FSM to be invoked once the FSM changes to a given state, and moving to a given state can be done with additional arguments that will be passed to those callbacks.  
