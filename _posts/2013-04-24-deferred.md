...
The one exception is the "jQuery.Deferred - chainability" which relies, when run not with the deferred object as the context to both work and to return 'this':
